...
@EnableSwagger2
class Swagger {
    val metaData = ApiInfo("Microservice with Kotlin", "REST API", "1.0", "Terms of service", Contact("Akhil Suseelan", "", "akhils1392@outlook.com"), "", "https://www.apache.org/licenses/LICENSE-2.0")
